                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="gal-container">
                            <div class="row">
                                <?php foreach ($getTradisional as $getT) : ?>
                                    <div class="col-4 col-md-4 col-sm-4">
                                        <!---Validation-->
                                        <div class="box mb-4">
                                            <a href="#" data-toggle="modal" data-target="#<?= $getT['detail_data_target']; ?>">
                                                <img src="<?= base_url('assets_home/images/'); ?><?= $getT['gambar_makanan']; ?>" alt="" />
                                            </a>
                                            <div class="modal fade" id="<?= $getT['detail_data_target']; ?>" tabindex="-1" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"><?= $getT['nama_makanan']; ?>
                                                            </h5>
                                                        ...
                                                        <div class="container container-modal">
                                                            <div class="row">
                                                                <?php foreach ($getTradisionalGalleri as $getTG) : ?>
                                                                    <?php if ($getT['id'] == $getTG['id_kode_tradisional']) : ?>
                                                                        <div class="col-md-4 modal-item">
                                                                            <img src="<?= base_url('assets_home/images/') ?><?= $getTG['tradisional_gambar']; ?>">
                                                                        </div>
                                                                    <?php endif; ?>
                                                                <?php endforeach; ?>
                                                            </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <ul>
                                                                <li>Lokasi &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: <span id="lok"><?= $getT['lokasi_makanan']; ?></span></li>
                                                                <li>Jam Buka/Tutup :&nbsp<span id="jam"><?= $getT['jambuka_makanan']; ?></span></li>
                                                                <li>Harga &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: <span id="harga">Rp.<?= $getT['harga_makanan']; ?></span></li>
                                                            </ul>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
                                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#<?= $getT['detail_item_target'];  ?>">Pesan</button>
                                                            <div class="modal fade" id="<?= $getT['detail_item_target'];  ?>" tabindex="-1" role="dialog" aria-labelledby="<?= $getT['detail_item_target'];  ?>" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-primary">
                                                                            <h5 class="modal-title" id="exampleModalLabel">Pesan&nbsp<?= $getT['nama_makanan']; ?> </h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <table class="table">
                                                                            ...
                                                                            <tbody>
                                                                                <?php $k = 1; ?>
                                                                                <?php foreach ($getTradisionalItem as $getTI) : ?>
                                                                                    <?php if ($getT['id'] == $getTI['makanan_id']) : ?>
                                                                                        <tr>
                                                                                            <th scope="row"><?= $k; ?></th>
                                                                                            <td><?= $getTI['nama_makanan']; ?></td>
                                                                                            <td>Rp. <?= $getTI['harga_makanan']; ?></td>
                                                                                        </tr>
                                                                                        <?php $k++ ?>
                                                                                    <?php endif; ?>
                                                                                <?php endforeach; ?>
